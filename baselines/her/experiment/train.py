...
def launch(
    ...
    batch_size, replay_k, override_params={}, save_policies=True
):
    ...
    # Adding the following lines to help in running scripts
...
@click.option('--batch_size', type=int, default=256, help='the number of CPU cores to use (using MPI)')
@click.option('--replay_k', type=int, default=4, help='the number of CPU cores to use (using MPI)')
def main(**kwargs):
    launch(**kwargs)
