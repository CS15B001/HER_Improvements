...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
                 ...
                 sample_transitions, gamma, replay_k, n_reps, reward_fun=None, reuse=False, **kwargs):
        ...
        self.buffer = ReplayBuffer(buffer_shapes, buffer_size, self.T, self.sample_transitions, conf, self.replay_k, self.n_reps, self.nonuniform_sampling)
